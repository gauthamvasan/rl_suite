...
class SACExperiment(Experiment):
    ...
    def parse_args(self):
        ...
        # Task
        parser.add_argument('--env', default='dm_reacher_hard', type=str)
        ...
        parser.add_argument('--N', default=350000, type=int, help="# timesteps for the run")
        parser.add_argument('--timeout', default=100, type=int, help="Timeout for the env")
        # Algorithm
        parser.add_argument('--algo', default="sac_rad", type=str, help="Choices: ['sac', 'sac_rad']")
        ...
        parser.add_argument('--description', '-no_image', type=str)
    ...
    def run(self):
        ...
        for t in range(self.args.N):                      
            ...
            if t < self.args.init_steps:
                ...
                if self.args.algo == "sac":
                    action = learner.sample_action(prop)                
                else:
            ...
            # Learn
            if self.args.algo == "sac":
                learner.push_and_update(prop, action, r, done)
            else:
