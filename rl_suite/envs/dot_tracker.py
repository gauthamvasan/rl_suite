...
class DotTracker(Env):
    def __init__(self, dt=0.2, timeout=10000, pos_tol=0.05, penalty=-1, seed=42, use_image=False) -> None:
        super().__init__()
        self.dt = dt
    ...
    def step(self, action):
        ...
        # Observation
        next_obs = np.concatenate((self.pos, self.vel))
...
if __name__ == "__main__":       
    ...
    timeout = 20000
    seed = 42
    env = DotTracker(dt=0.2, timeout=timeout) 
